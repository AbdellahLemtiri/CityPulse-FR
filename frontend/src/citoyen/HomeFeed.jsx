...
// Skeleton
const SkeletonPost = () => (
  <div className="bg-white dark:bg-gray-800 px-1.5 md:rounded-lg border-y md:border border-gray-200 dark:border-gray-700 mb-6 animate-pulse">
  ...
  const handleSendComment = async (articleId) => {
    ...
    try {
      ...
      if (!replyingToId) {
        ...
        setPosts((prevPosts) => prevPosts.map((p) => (p.id === articleId ? { ...p, comments_count: p.comments_count + 1 } : p)));
      } else {
        setComments((prev) =>
          prev.map((comment) => {
        ...
        {loading && page === 1 ? (
          ...
          <>
            {posts.map((post, index) => {
              ...
              return (
                <div key={post.id} ref={isLastPost ? lastPostElementRef : null} className="relative bg-white dark:bg-gray-800 px-1.5 md:rounded-lg border-y md:border border-gray-200 dark:border-gray-700 mb-6">
                  <div className="p-4 flex items-center gap-3">
                  ...
                  <div className="px-2 py-1 flex justify-between border-t border-gray-200 dark:border-gray-700 mt-2">
                    <button onClick={() => handlLikeart(post)} className="hover:bg-gray-50 dark:hover:bg-gray-700 flex-1 flex items-center justify-center py-1 text-gray-500 dark:text-gray-400 rounded-lg group">
