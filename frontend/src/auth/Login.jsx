  ...
  return (
    <div className="font-sans min-h-screen flex flex-col items-center justify-center p-4 relative overflow-x-hidden bg-[#F8FAFC] dark:bg-[#020617] text-[#0F172A] dark:text-white transition-colors duration-300">
      ...
      <div className="absolute -bottom-20 -right-20 w-80 h-80 bg-blue-500/10 rounded-lg blur-3xl pointer-events-none" />
       ...
       <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-lg shadow-2xl border border-gray-100 dark:border-slate-800 p-8 md:p-10 relative z-10 animate-[fadeInUp_0.5s_ease-out]">
         <div className="text-center mb-8">
          <div className="w-14 h-14 bg-gradient-to-br from-[#EA580C] to-orange-600 rounded-lg flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-500/30 text-white">
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              <input
                ...
                } text-gray-900 dark:text-white rounded-lg py-3.5 pl-11 pr-4 focus:outline-none focus:ring-2 focus:ring-[#EA580C]/50 transition-all font-medium`}
              />
           ...
           <div className="space-y-1">
            ...
            <div className="relative group">
              <input
                ...
                } text-gray-900 dark:text-white rounded-lg py-3.5 pl-11 pr-11 focus:outline-none focus:ring-2 focus:ring-[#EA580C]/50 transition-all font-medium`}
              />
              <span className="material-symbols-outlined absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-[#EA580C] transition-colors">
                lock
              </span>
           ...
           <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#EA580C] hover:bg-orange-700 text-white font-bold py-4 rounded-lg shadow-xl shadow-orange-500/20 transition-transform active:scale-[0.98] flex items-center justify-center gap-2 mt-4 disabled:opacity-70 disabled:cursor-not-allowed"
          >
