    ...
    <div className="flex h-screen bg-gray-100 font-sans">
       ...
       <aside className="w-64 bg-gray-900 flex flex-col shadow-xl z-10">
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          ...
          <p className="text-[10px] font-bold text-gray-500 uppercase mb-3 mt-6 tracking-widest">Système</p>
          <NavLink to="/admin/systeme" className={navLinkStyle}>
            Audit & Sauvegardes
          </NavLink>
        </nav>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* L-BLASSA FIN KAY-T-CHARGAW LES PAGES */}
